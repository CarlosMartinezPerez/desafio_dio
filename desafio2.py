...
def abre_conta(nome, num_conta, saldo=0):
    return

def depositar(num_conta, valor):
        return

def sacar(num_conta_valor):
    return

def extrato(num_conta):
    return
...
while True:
    ...
    if opcao == "d":
        ...
        if valor > 0:
            ...
            print(f"Seu depósito de {valor} foi realizado com sucesso!")
        ...
        print("Banco X - SEMPRE A SEU DISPOR!")
        print("==========================================")
